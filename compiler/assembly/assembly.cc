...
static const unsigned char bf_actions[791] = {
  221,4,37,237,255,248,1,255,248,2,255,248,3,255,248,4,255,248,5,255,248,6,
  255,248,7,255,248,8,255,248,9,255,252,233,244,247,255,252,233,244,248,255,
  252,233,244,249,255,252,233,244,250,255,252,233,244,251,255,252,233,244,252,
  255,252,233,244,253,255,252,233,244,254,255,252,233,244,255,255,252,233,244,
  1,255,252,233,244,2,255,252,233,244,3,255,252,233,244,4,255,252,233,244,5,
  255,252,233,244,6,255,252,233,244,7,255,252,233,244,8,255,252,233,244,9,255,
  15,133,244,247,255,15,132,244,247,255,15,134,244,247,255,15,131,244,247,255,
  ...
  9,255,221,28,37,237,102,15,18,4,37,237,195,255,222,193,255,222,252,233,255,
  222,201,255,222,252,249,255,217,224,255,217,252,250,255,223,252,241,221,216,
  255
};
            ...
            case 1:
                {
                    //| jmp >1
                    dasm_put(Dst, 32);
#line 111 "compiler/assembly/assembly.dasc"
                    printf(">1 \n");
                    break;
                }
            case 2:
...
#line 230 "compiler/assembly/assembly.dasc"
            ...
            //| je  >1
            dasm_put(Dst, 127);
#line 232 "compiler/assembly/assembly.dasc"
        else if(labelNumber == 1 && operator_==GT)
            //| jbe  >1
            dasm_put(Dst, 132);
#line 234 "compiler/assembly/assembly.dasc"
...
#line 342 "compiler/assembly/assembly.dasc"
            ...
            //| ja  >1
            dasm_put(Dst, 147);
#line 344 "compiler/assembly/assembly.dasc"
        else if(labelNumber == 1 && operator_==LT)
			 //| jb  >1
			 dasm_put(Dst, 142);
...
void Assembly::conditionalJumpBackwardTo(int labelNumber, bool condition){
    if(condition == false){
        if(labelNumber == 1  && operator_==EQ)
			 //| jne  <1
			 dasm_put(Dst, 437);
#line 565 "compiler/assembly/assembly.dasc"
        else if(labelNumber == 1 && operator_==NE)
			 //| je  <1
			 dasm_put(Dst, 442);
#line 567 "compiler/assembly/assembly.dasc"
        else if(labelNumber == 1 && operator_==GT)
			 //| jbe  <1
			 dasm_put(Dst, 447);
#line 569 "compiler/assembly/assembly.dasc"
        else if(labelNumber == 1 && operator_==LT)
			 //| jae  <1
			 dasm_put(Dst, 452);
        ...
        case IDENTITY:
            {
                ...
                //| ret
                dasm_put(Dst, 752, result, result);
          ...
          case GT:
            {
                ...
                //| fpop
                dasm_put(Dst, 785);
#line 859 "compiler/assembly/assembly.dasc"
                printf("fcomip st1 \n");
                printf("fpop \n");
                break;
            }
          ...
          case GTE:
            {
                ...
                //| fpop
                dasm_put(Dst, 785);
#line 875 "compiler/assembly/assembly.dasc"
                printf("fcomip st1 \n");
                printf("fpop \n");
                break;
            }
          case LTE:
            {
                ...
                //| fpop
                dasm_put(Dst, 785);
#line 883 "compiler/assembly/assembly.dasc"
                printf("fcomip st1 \n");
                printf("fpop \n");
                break;
            }
